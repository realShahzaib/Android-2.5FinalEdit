package com.hybridproduct.apps.nearbystores.adapter.lists;
...
import com.hybridproduct.apps.nearbystores.animation.ImageLoaderAnimation;
import com.hybridproduct.apps.nearbystores.classes.Offer;
import com.hybridproduct.apps.nearbystores.utils.OfferUtils;
    ...
    public void onBindViewHolder(OfferListAdapter.mViewHolder holder, int position) {
        ...
        /*if (data.get(position).getDistance() != null) {
            ...
            if (data.get(position).getDistance() > 0) {
                ...
                String symbole = com.droideve.apps.nearbystores.utils.Utils.getDistanceBy(
                        data.get(position).getDistance()
                );
                String distance = com.droideve.apps.nearbystores.utils.Utils.preparDistance(
                        data.get(position).getDistance()
                );
